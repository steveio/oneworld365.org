...
//$paypal[business]="seller_1248708521_biz@oneworld365.org";
$paypal[business]= "admin@summercampworldwide.com";
$paypal[site_url]="http://www.oneworld365.org/";
$paypal[image_url]="images/oneworld_logo_wip_240px.gif";
//$paypal[success_url]="advertise.php";
//$paypal[success_url]="php_paypal/ipn/ipn.php";
//$paypal[cancel_url]="lib/php_paypal/error.php";
$paypal[cancel_url]="advertise.php";
$paypal[notify_url]="lib/php_paypal/ipn/ipn.php";
...
$paypal[continue_button_text]="Complete Order >>";
